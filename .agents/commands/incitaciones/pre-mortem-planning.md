...
type: task
tags: [planning, risk-management, foresight]
status: tested
---
...
This task is used during the planning phase of a project to proactively identify potential failure points. By imagining a future where the project has failed, the team can uncover risks that might otherwise be overlooked and develop mitigation strategies early on. It's particularly useful for high-stakes projects or those with significant uncertainty.
