> [!CAUTION]
> **DEPRECATED (2026-03-08)**: This specification has been moved to the [chacana](https://github.com/sashakile/chacana) repository.
> **DO NOT EDIT THIS FILE.** All future changes must be made in the new repository.
> No implementation exists in sxAct — Chacana is an independent project.
