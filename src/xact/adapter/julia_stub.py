...
from xact.normalize import normalize as _normalize
...
class JuliaAdapter(TestAdapter[_JuliaContext]):
    ...
    def _def_manifold(self, ctx: _JuliaContext, args: dict[str, Any]) -> Result:
        from xact.compare.tensor_objects import Manifold
    ...
    def _def_tensor(self, ctx: _JuliaContext, args: dict[str, Any]) -> Result:
        from xact.compare.tensor_objects import TensorField
    ...
    def _def_metric(self, ctx: _JuliaContext, args: dict[str, Any]) -> Result:
        ...
        from xact.compare.tensor_objects import Metric
    ...
    def get_tensor_context(self, ctx: _JuliaContext, rng: "Any | None" = None) -> "Any":
        ...
        Returns a :class:`~xact.compare.sampling.TensorContext` populated with
        random component arrays for all tensors and metrics defined in this context.
        Pass the result to :func:`~xact.compare.sampling.sample_numeric` for
        ...
        """
        from xact.compare.sampling import build_tensor_context
