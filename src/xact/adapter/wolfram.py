...
from xact.oracle.client import OracleClient
...
class WolframAdapter(TestAdapter[_WolframContext]):
    ...
    Wraps :class:`~xact.oracle.client.OracleClient`, mapping the abstract
    ...
    def equals(
        ...
        from xact.compare.sampling import sample_numeric
