...
# Re-export everything the tests import from xact.cli
from .run import (
...
def _cmd_benchmark(args: argparse.Namespace) -> int:
    from xact.benchmarks.runner import (
        BenchResult,
        bench_test_case,
        check_regression,
        load_baseline,
    ...
    if args.record:
        from xact.benchmarks.runner import collect_machine_info
...
def _cmd_benchmark_compare(
    ...
    from xact.benchmarks.runner import bench_test_case, BenchResult
    from xact.runner.loader import load_test_file, LoadError
