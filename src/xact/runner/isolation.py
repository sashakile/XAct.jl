...
Public API::
    ...
    from xact.runner.isolation import IsolatedContext, TestResult
...
from xact.adapter.base import EqualityMode, TestAdapter
from xact.oracle.result import Result
from xact.runner.loader import TestCase, TestFile
...
class IsolatedContext:
    ...
    def run_test(self, tc: TestCase) -> TestResult:
        ...
        Args:
            tc: A :class:`~xact.runner.loader.TestCase` from the same
                :class:`~xact.runner.loader.TestFile` passed at construction.
