...
class SnapshotComparator:
    """Compares actual adapter results against a :class:`~xact.snapshot.store.SnapshotStore`.

    Args:
        store: A loaded :class:`~xact.snapshot.store.SnapshotStore`.
    """
    ...
    def compare(
        ...
        Args:
            ...
            actual:   The :class:`~xact.oracle.result.Result` produced by
