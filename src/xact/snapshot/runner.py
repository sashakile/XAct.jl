...
be handed to :mod:`xact.snapshot.writer` to persist as the oracle directory.

Public API::

    from xact.snapshot.runner import run_file, FileSnapshot, TestSnapshot
...
from xact.runner.loader import Operation, TestCase, TestFile
