...
from xact.snapshot.runner import TestSnapshot, compute_oracle_hash
...
class SnapshotStore:
    ...
    def load(self, meta_id: str, test_id: str) -> Optional[TestSnapshot]:
        ...
        Returns:
            The :class:`~xact.snapshot.runner.TestSnapshot`, or ``None`` if
    ...
    def verify_hash(self, snap: TestSnapshot) -> bool:
        ...
        Args:
            snap: A :class:`~xact.snapshot.runner.TestSnapshot` previously
